...
<body >
     ...
     <nav class="navbar navbar-expand-lg navbar-light bg-white">
       ...
       <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
               <a class="nav-link" href="../../gutystore/views/inicio.php">Inicio<span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
               <a class="nav-link" href="../../gutystore/views/producto.php">Productos</a>
              </li>
              <li class="nav-item">
               <a class="nav-link" href="../../gutystore/views/unidad_medida.php">Medidas</a>
              </li>
              <li class="nav-item">
               <a class="nav-link" href="../../gutystore/views/pais.php">Paises</a>
              </li>
              <li class="nav-item">
               <a class="nav-link" href="../../gutystore/views/marca.php">Marcas</a>
              </li>
              <li class="nav-item">
               <a class="nav-link" href="../../gutystore/views/permiso.php">Permisos</a>
              </li>
              <li class="nav-item">
               <a class="nav-link" href="../../gutystore/views/rol.php">Roles</a>
              </li>
              <li class="nav-item">
               <a class="nav-link" href="../../gutystore/views/color.php">Colores</a>
              </li>
              <li class="nav-item">
               <a class="nav-link" href="../../gutystore/views/categoria.php">Categoria</a>
              </li>
              <li class="nav-item">
               <a class="nav-link" href="../../gutystore/views/usuario.php">Usuario</a>
              </li>
              <li class="nav-item">
               <a class="nav-link" href="../../gutystore/views/logout.php">Logout</a>
              </li>
         </ul>
      </div>
     </nav>
